import {
  ...
  const projects = [
    ...
    },
    {
      name: "Summize",
      description:
        "An AI-powered website that provides concise summaries of any webpage you enter. With just a URL, our cutting-edge technology generates condensed summaries, saving you time and effort. Say goodbye to lengthy reading and information overload – try Summize now for quick and efficient content summarization!",
      tags: [
        {
          name: "react",
          color: "blue-text-gradient",
